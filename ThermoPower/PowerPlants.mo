  ...
  package GasTurbine
    ...
    package Examples "Example implementations"
      ...
      model GasTurbineSimplified
        ...
        parameter SI.Power maxPower=235e6;
        parameter SI.MassFlowRate flueGasNomFlowRate=614
          "Nominal flue gas flow rate";
        parameter SI.MassFlowRate flueGasMinFlowRate=454
          "Minimum flue gas flow rate";
        parameter SI.MassFlowRate flueGasOffFlowRate=
            flueGasMinFlowRate/100 "Flue gas flow rate with GT switched off";
        parameter SI.MassFlowRate fuelNomFlowRate=12.1
          "Nominal fuel flow rate";
        parameter SI.MassFlowRate fuelIntFlowRate=7.08
          "Intermediate fuel flow rate";
        parameter SI.MassFlowRate fuelMinFlowRate=4.58
          "Minimum fuel flow rate";
        parameter SI.MassFlowRate fuelOffFlowRate=0.1
        ...
        parameter SI.Temperature flueGasNomTemp=843
          "Maximum flue gas temperature";
        parameter SI.Temperature flueGasMinTemp=548
          "Minimum flue gas temperature (zero electrical load)";
        parameter SI.Temperature flueGasOffTemp=363.15
          "Flue gas temperature with GT switched off";
        parameter SI.SpecificEnthalpy fuel_LHV=49e6
          "Fuel Lower Heating Value";
        parameter SI.SpecificEnthalpy fuel_HHV=55e6
          "Fuel Higher Heating Value";
        FlueGasMedium.BaseProperties gas;
        SI.MassFlowRate w;
        SI.Power P_el=noEvent(if GTLoad > 0 then GTLoad*maxPower
             else 0) "Electrical power output";
        SI.MassFlowRate fuelFlowRate "Fuel flow rate";
      equation
        gas.p = flueGasOut.p;
...
<li><i>1 Oct 2003</i>
    by <a href=\"mailto:francesco.casella@polimi.it\">Francesco Casella</a>:<br>
      ...
      model PrescribedSpeedPump "Prescribed speed pump"
        ...
        parameter NonSI.AngularVelocity_rpm n0
          "Nominal rpm";
